...
#define SOFTWARE_NAME "TFS Exclusive"
#define SOFTWARE_VERSION "5.2"
#define MINOR_VERSION "X"
#define PATCH_VERSION "SERIES"
#define REVISION_VERSION "-"
#define SOFTWARE_CODENAME "Crying Damson"
#define SOFTWARE_DEVELOPERS "Mark Samman and The Forgotten Server Developers and nolanggz (doing changes now)"

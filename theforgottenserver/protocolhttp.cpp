...
void ProtocolHTTP::onRecvFirstMessage(NetworkMessage&)
{
	...
	output->addString("Date: Wed, 29 Set 2021 21:00.13 GMT\r\n");
	output->addString("Server: The TFS Server httpd/2.X.Series\r\n");
	output->addString("Content-Location: index.html\r\n");
	//Vary: negotiate\r\n
	//TCN: choice\r\n
	output->addString("Last-Modified: Wed, 29 Set 2021 20:50.13 GMT\r\n");
	output->addString("Accept-Ranges: bytes\r\n");
	output->addString("Content-Length: 1234\r\n");
	output->addString("Expires: Wed, 1 October 2021 21:28.13 GMT\r\n");
	output->addString("Connection: close\r\n");
	output->addString("Content-Type: text/html qs=0.7\r\n");
	output->addString("\r\n");
	output->addString("<html><head><title>The TFS Server httpd</title></head><body>It works (apache ripoff ;D)!</body></html>");
